...
public class Enemy extends GameObject {
  public Enemy(float x, float y, Visual visual, Controller controller) {
    super(x, y, visual, controller);
    this.gravityX[0] = 0.001f;
  }

  public Enemy(float x, float y, float velX, float velY, Visual visual, Controller controller, float mass) {
