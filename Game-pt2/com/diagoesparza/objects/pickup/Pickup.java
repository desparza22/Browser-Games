...
public class Pickup extends GameObject {
  public Pickup(float x, float y, Visual visual, Controller controller) {
    super(x, y, visual, controller);
  }
  public Pickup(float x, float y, float velX, float velY, Visual visual, Controller controller, float mass) {
